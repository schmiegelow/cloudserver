...
const AwsClient = arsenal.storage.data.external.AwsClient;
const GcpClient = arsenal.storage.data.external.GcpClient;
const AzureClient = arsenal.storage.data.external.AzureClient;
const PfsClient = arsenal.storage.data.external.PfsClient;
